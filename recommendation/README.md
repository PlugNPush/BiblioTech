...
Insert que j'ai yuliser pour l'exemple

INSERT INTO user (firstname, lastname, email, password) VALUES ('John', 'Doe', 'john.doe@example.com', 'password123');
...
commit;
```
>>>>>>> c0ae4c59a53d10dab5edc18bf308196a1b944965
